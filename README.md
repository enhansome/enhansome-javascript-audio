...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,333 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [node-easymidi](https://github.com/dinchak/node-easymidi) ⭐ 196 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-05 - a wrapper around [node-midi](https://github.com/justinlatimer/node-midi) ⭐ 761 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-12 to make things easier
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,709 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-13 - control MIDI instruments/messages with ease
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,715 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-07 - A Web Audio framework for making interactive music in the browser
...
* [tonejs-instruments](https://github.com/nbrosowsky/tonejs-instruments) ⭐ 537 | 🐛 5 | 🌐 JavaScript | 📅 2023-06-01 - instrument presets for Tone.js
...
* [tuna](https://github.com/Theodeus/tuna) ⭐ 1,828 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-06 - an audio effects library for the Web Audio API
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,668 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-27 - very nice multi-track WAV editor, similar to Audacity :)
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 388 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-15 - MIDI player with tracker, loads of settings
...
* [kevin-chau/minimoog.js](https://github.com/kevin-chau/minimoog.js) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2017-02-10 - a Minimoog synth
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,094 | 🐛 2 | 🌐 C++ | 📅 2026-08-16 - requires isgn up. A highly automated and intuitive DAW
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,849 | 🐛 29 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,373 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-10 - generate navigable waveforms
...
* [kelvinau/circular-audio-wave](https://github.com/kelvinau/circular-audio-wave) ⭐ 280 | 🐛 14 | 🌐 JavaScript | 📅 2024-05-18 - circular audio waves powered by E-charts
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,324 | 🐛 241 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
