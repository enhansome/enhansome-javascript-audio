...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,345 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,720 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-15 - A Web Audio framework for making interactive music in the browser
...
* [octavian](https://github.com/stevekinney/octavian) ⭐ 181 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - utilities for reasoning about musical notes, frequencies, and intervals
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 400 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - MIDI player with tracker, loads of settings
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,124 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - requires isgn up. A highly automated and intuitive DAW
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,413 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,342 | 🐛 251 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
