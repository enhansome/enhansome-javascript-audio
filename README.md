...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,341 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [mudcube/MIDI.js](https://github.com/mudcube/MIDI.js) ⚠️ Archived - can play midi files using the given soundFonts
  * [midi-js-soundfonts](https://github.com/gleitz/midi-js-soundfonts) ⭐ 784 | 🐛 7 | 📅 2022-03-09 - pre-rendered, MIDI soundfonts for use with MIDI.js
* [grimmdude/MidiWriterJS](https://github.com/grimmdude/MidiWriterJS) ⭐ 605 | 🐛 9 | 🌐 JavaScript | 📅 2026-06-16 - an API for programmatically generating multi-track MIDI files and JSON objects
...
* [colxi/MidiParser](https://github.com/colxi/midi-parser-js) ⭐ 245 | 🐛 13 | 🌐 JavaScript | 📅 2023-08-12 - a binary MIDI file reader for browser/Node, converts a MIDI binary file to a JSON object
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,712 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03 - control MIDI instruments/messages with ease
...
* [surikov/webaudiofont](https://github.com/surikov/webaudiofont) ⭐ 988 | 🐛 3 | 🌐 HTML | 📅 2026-09-04 - use full GM set of musical instruments to play MIDI and single sounds or effects
* [midi-js-soundfonts](https://github.com/gleitz/midi-js-soundfonts) ⭐ 784 | 🐛 7 | 📅 2022-03-09 - pre-rendered, MIDI soundfonts for use with MIDI.js
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,716 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-03 - A Web Audio framework for making interactive music in the browser
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,676 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 - very nice multi-track WAV editor, similar to Audacity :)
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 395 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - MIDI player with tracker, loads of settings
* [efflux-tracker](https://github.com/igorski/efflux-tracker) ⭐ 260 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - browser based music tracker ([here](https://www.igorski.nl/application/efflux/)) driving a modular synth environment with MIDI support
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,113 | 🐛 2 | 🌐 C++ | 📅 2026-09-07 - requires isgn up. A highly automated and intuitive DAW
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,860 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,402 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-03 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,334 | 🐛 244 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
...
* [g200kg/webaudio-controls](https://github.com/g200kg/webaudio-controls) ⭐ 371 | 🐛 20 | 🌐 JavaScript | 📅 2025-10-04 - web components aimed at VST instruments, DAWs, etc
