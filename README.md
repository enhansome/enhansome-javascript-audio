...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,717 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-21 - A Web Audio framework for making interactive music in the browser
...
* [tonejs-instruments](https://github.com/nbrosowsky/tonejs-instruments) ⭐ 543 | 🐛 5 | 🌐 JavaScript | 📅 2023-06-01 - instrument presets for Tone.js
...
* [efflux-tracker](https://github.com/igorski/efflux-tracker) ⭐ 260 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-28 - browser based music tracker ([here](https://www.igorski.nl/application/efflux/)) driving a modular synth environment with MIDI support
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,110 | 🐛 2 | 🌐 C++ | 📅 2026-09-01 - requires isgn up. A highly automated and intuitive DAW
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,393 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,330 | 🐛 244 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
