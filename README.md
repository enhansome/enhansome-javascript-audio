...
* [scribbletune/johann](https://scribbletune.github.io/johann/) - Generate chord & scale charts to practice - for guitar, piano and PC keyboard ([repo](https://github.com/scribbletune/johann) ⭐ 62 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-28)
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,725 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-16 - A Web Audio framework for making interactive music in the browser
...
* [scribbletune](https://scribbletune.com/) - generate chord progressions, scales, beats, save as MIDI clips, with [a teacher app](https://github.com/scribbletune/johann) ⭐ 62 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-28 and [sampler](https://github.com/scribbletune/sampler) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2019-12-08
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 400 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-17 - MIDI player with tracker, loads of settings
...
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,866 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,417 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
