...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,344 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,714 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-14 - control MIDI instruments/messages with ease
...
* [AndrejHronco/midi-ports](https://github.com/AndrejHronco/midi-ports) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - small library to manage attached MIDI ports and devices
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,719 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-10 - A Web Audio framework for making interactive music in the browser
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 399 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - MIDI player with tracker, loads of settings
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,122 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - requires isgn up. A highly automated and intuitive DAW
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,412 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
