...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,343 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,863 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,408 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,336 | 🐛 246 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
