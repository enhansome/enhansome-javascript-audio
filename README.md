...
* [mudcube/MIDI.js](https://github.com/mudcube/MIDI.js) ⚠️ Archived - can play midi files using the given soundFonts
  * [midi-js-soundfonts](https://github.com/gleitz/midi-js-soundfonts) ⭐ 784 | 🐛 5 | 📅 2022-03-09 - pre-rendered, MIDI soundfonts for use with MIDI.js
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,714 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-09 - control MIDI instruments/messages with ease
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,677 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 - very nice multi-track WAV editor, similar to Audacity :)
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 397 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - MIDI player with tracker, loads of settings
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,116 | 🐛 2 | 🌐 C++ | 📅 2026-09-09 - requires isgn up. A highly automated and intuitive DAW
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,406 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-03 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,334 | 🐛 245 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
