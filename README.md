...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,334 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,705 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-07 - A Web Audio framework for making interactive music in the browser
...
* [sebpiq/WebPd](https://github.com/sebpiq/WebPd) ⭐ 998 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-02 - use your [Pure Data](https://puredata.info/) [patches](https://puredata.info/community/member-downloads/patches) in Javascript
...
* [efflux-tracker](https://github.com/igorski/efflux-tracker) ⭐ 260 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21 - browser based music tracker ([here](https://www.igorski.nl/application/efflux/)) driving a modular synth environment with MIDI support
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,098 | 🐛 2 | 🌐 C++ | 📅 2026-08-18 - requires isgn up. A highly automated and intuitive DAW
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,853 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,381 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,326 | 🐛 244 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
