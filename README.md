...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,342 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,714 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-09 - control MIDI instruments/messages with ease
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,718 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-10 - A Web Audio framework for making interactive music in the browser
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,677 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-10 - very nice multi-track WAV editor, similar to Audacity :)
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 398 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - MIDI player with tracker, loads of settings
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,117 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - requires isgn up. A highly automated and intuitive DAW
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,864 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,410 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,340 | 🐛 249 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
