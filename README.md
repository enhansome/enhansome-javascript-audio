...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,339 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [mudcube/MIDI.js](https://github.com/mudcube/MIDI.js) ⚠️ Archived - can play midi files using the given soundFonts
  * [midi-js-soundfonts](https://github.com/gleitz/midi-js-soundfonts) ⭐ 783 | 🐛 7 | 📅 2022-03-09 - pre-rendered, MIDI soundfonts for use with MIDI.js
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,718 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-03 - A Web Audio framework for making interactive music in the browser
...
* [tonejs-instruments](https://github.com/nbrosowsky/tonejs-instruments) ⭐ 544 | 🐛 5 | 🌐 JavaScript | 📅 2023-06-01 - instrument presets for Tone.js
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,675 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 - very nice multi-track WAV editor, similar to Audacity :)
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 395 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - MIDI player with tracker, loads of settings
...
* [webaudio-tinysynth](https://github.com/g200kg/webaudio-tinysynth) ⭐ 273 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-20 - webaudio-tinysynth is a small synthesizer written in JavaScript with GM like timbre map
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,112 | 🐛 2 | 🌐 C++ | 📅 2026-09-03 - requires isgn up. A highly automated and intuitive DAW
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,396 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-03 - generate navigable waveforms
