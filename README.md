...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,347 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - cross-browser audio library, 7kb, with multi-track, caching, falls back to HTML5 audio
...
* [grimmdude/MidiWriterJS](https://github.com/grimmdude/MidiWriterJS) ⭐ 606 | 🐛 9 | 🌐 JavaScript | 📅 2026-06-16 - an API for programmatically generating multi-track MIDI files and JSON objects
...
* [webmidi](https://github.com/djipco/webmidi) ⭐ 1,714 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-15 - control MIDI instruments/messages with ease
...
* [scribbletune/johann](https://scribbletune.github.io/johann/) - Generate chord & scale charts to practice - for guitar, piano and PC keyboard ([repo](https://github.com/scribbletune/johann) ⭐ 61 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-28)
...
* [surikov/webaudiofont](https://github.com/surikov/webaudiofont) ⭐ 989 | 🐛 3 | 🌐 HTML | 📅 2026-09-04 - use full GM set of musical instruments to play MIDI and single sounds or effects
* [midi-js-soundfonts](https://github.com/gleitz/midi-js-soundfonts) ⭐ 785 | 🐛 5 | 📅 2022-03-09 - pre-rendered, MIDI soundfonts for use with MIDI.js
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,722 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-16 - A Web Audio framework for making interactive music in the browser
...
* [tonejs-instruments](https://github.com/nbrosowsky/tonejs-instruments) ⭐ 545 | 🐛 5 | 🌐 JavaScript | 📅 2023-06-01 - instrument presets for Tone.js
* [octavian](https://github.com/stevekinney/octavian) ⭐ 181 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - utilities for reasoning about musical notes, frequencies, and intervals
...
* [Flocking](https://github.com/colinbdclark/Flocking) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - declaratively create sounds, synths, effects, etc, as JSON objects, supports mouse/trackpad
...
* [scijs/periodic-function](https://github.com/scijs/periodic-function) ⭐ 58 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-11 - oscillator modifiers (sawtooth, square, sine, pulse, step, interpolate, etc) as JS functions, normalized 0..1
...
* [tuna](https://github.com/Theodeus/tuna) ⭐ 1,830 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-06 - an audio effects library for the Web Audio API
* [alemangui/pizzicato](https://github.com/alemangui/pizzicato) ⭐ 1,711 | 🐛 78 | 🌐 JavaScript | 📅 2025-07-09 - excellent sound shaping effects, [nice demos](https://alemangui.github.io/pizzicato/) showing guitar sounds
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,678 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-10 - very nice multi-track WAV editor, similar to Audacity :)
...
* [completejavascript/drum-machine](https://github.com/completejavascript/drum-machine) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2022-04-07 - simple react based MPD
* [dburles/ssu16](https://github.com/dburles/ssu16) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2019-06-22 - very slick Akai-like MPC, with step sequencing, sample import, much more
...
* [SpessaSynth](https://github.com/spessasus/SpessaSynth) ⭐ 400 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-16 - MIDI player with tracker, loads of settings
...
* [sf2synth.js](https://github.com/logue/sf2synth.js) ⭐ 35 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-13 - a WebMidiLink based synthesizer with SoundFont support
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,125 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - requires isgn up. A highly automated and intuitive DAW
* [gridsound](https://github.com/gridsound/daw) ⭐ 1,865 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-28 - a lovely open source DAW, uses Web Audio API
...
* [katspaugh/wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,416 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - generate navigable waveforms
...
* [waveplayer.js](https://github.com/michaeldzjap/waveplayer.js) ⭐ 81 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - mp3 player that produces wavforms
...
* [paulrosen/abcjs](https://github.com/paulrosen/abcjs) ⭐ 2,342 | 🐛 252 | 🌐 HTML | 📅 2026-08-09 - for rendering music notation
* [nexus-js/ui](https://github.com/nexus-js/ui) ⭐ 875 | 🐛 45 | 🌐 JavaScript | 📅 2025-07-03 - very nice UI toolkit for web based MIDI instrument [UI components](https://nexus-js.github.io/ui/) (used by nofft, above)
